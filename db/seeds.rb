...
Event.create title: "Giant Financial Cocktail Mixer", location: "Great Hall", date: DateTime.new(2013,9,1,17), end_date: DateTime.new(2013,9,1,19)
Event.create title: "Goldman Sachs Recruiting Kick-off", location: "Great Hall", date: DateTime.new(2013,9,3,18.5), end_date: DateTime.new(2013,9,3,20.5)
Event.create title: "Morgan Stanley: Internships 101", location: "Great Hall", date: DateTime.new(2013,9,4,16.25), end_date: DateTime.new(2013,9,4,18.25)
Event.create title: "DB - Global Intern & Full-time Recruiting Seminar", location: "Great Hall", date: DateTime.new(2013,9,10,17), end_date: DateTime.new(2013,9,10,19.5)
